...
\end{align*}therefore 
\begin{align*}
	\int_U |Du|^2 \ge C\|u\|^2_{H_0^1(U)}
\end{align*}

\item WTS $a(u,v)$ is bounded in each case \begin{description}
	\item Case \#1: $n = 2, c \in L^p(U), p >1$.
	\begin{align*}
	...
	\item Case \#2: $n>3,\,c\in L^{n/2}(U)$.
	
	Using $p*=\frac{2n}{n-2}$ and 
	\begin{align*}
		H_0^1(U) &\hookrightarrow L^{p*} \\
		\text{then } \frac{1}{n/2}+\frac{2}{p*} &= \frac{2}{n}+\frac{2(n-2)}{2n} = \frac{2}{n}+\frac{n-2}{n}=1
...
\item WTS that $L(v)$ is bounded in each case \begin{description}
	...
	\item Case $(ii)$: $f \in L^{2n/n+2}$
	
	Let 
	\begin{align*}
		s = \frac{2n}{n+2}, q = \frac{2n}{n-2}
	\end{align*}
	Then applying H\"older's Inequality
	\begin{align*}
