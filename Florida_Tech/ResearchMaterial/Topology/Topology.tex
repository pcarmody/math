...
\begin{definition}[Dense] Let $A$ be a subset of a topological space $(X, \TT)$.  Then, $A$ is said to be \DEFINE{dense in $X$} or \DEFINE{everywhere dense in $X$} if $\CONJ{A} =X$.
\end{definition}
...
\begin{definition}[Subbasis] Let $(X, \TT)$ be a topological space.  A non-empty collection $\SB$ of open subsets of $X$ is said to be \DEFINE{subbasis} of $\TT$ if the collection of \underline{all finite intersections} of members of $\SB$ forms a basis for $\TT$.
\end{definition}
