...
\RED{Notes from Dr. B's feedback during presentation.  This is a more coordinate independent approach.}
\begin{center}

\begin{tikzpicture}

	% Drase a vector horizontally for ease of presentation (it needn't be horizontal).
    \draw[->, very thick, black] (0,0) -- (5,0) node[above right] {$\vec{C}$};
    ...
    % 4a. Draw a vector from the origin (0,0) to the point (3, 2)
    % The "->" option creates an arrow head
    \draw[dashed, very thick, blue] (3,2) -- (3,0) node[above right] {$\vec{A}\cdot\vec{C}$};
    ...
    % 5a. Draw a vector from the origin (0,0) to the point (3, 2)
    % The "->" option creates an arrow head
    \draw[dashed, very thick, red] (1,4) -- (1,0) node[above right] {$\vec{B}\cdot \vec{C}$};
    ...
    % 6. Draw a vector from the origin (0,0) to the point (3, 2)
    % The "->" option creates an arrow head
    \draw[dashed, very thick, violet] (4,6) -- (4,0) node[right] {($\vec{A}+\vec{B})\cdot\vec{C}$};
