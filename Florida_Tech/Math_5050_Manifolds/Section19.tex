...
\begin{align*}
	F(x,y) = (x^2+y^2,xy).
\end{align*}If $u,v$ are the standard coordinates on the traget $\R^2$, compute $F^*(udu+vdv)$.
...
\begin{align*}
	E=E_1dx+E_2dy+E_3dz
\end{align*}and the 2-form $B$ on $\R^3$ corresponding ot eh vector field $B$ is
\begin{align*}
